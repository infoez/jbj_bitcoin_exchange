...
; (function ($) {
    ...
    , close = function (evt_or_pane, force, noAnimation, skipCallback) {
        ...
        $N.queue(function (queueNext) {
            ...
            if (!$P
			|| (!o.closable && !s.isShowing && !s.isHiding)	// invalid core // (!o.resizable && !o.closable) ???
    ...
    , open = function (evt_or_pane, slide, noAnimation, noAlert) {
        ...
        $N.queue(function (queueNext) {
            ...
            if (!$P
			|| (!o.resizable && !o.closable && !s.isShowing)	// invalid core
...
(function ($) {
     ...
     *
     *	CUSTOM STATE-MANAGEMENT (eg, saved in a databaseservice)
